...
<template>
  <footer class="bg-[#2C3E50] text-white text-center py-20 px-4">
    <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        <h4 class="uppercase font-bold mb-4">Around the Web</h4>
        <div class="flex justify-center gap-3">
          <a
            ...
            class="w-12 h-12 rounded-full border border-white flex items-center justify-center text-xs uppercase hover:bg-[#1ABC9C] hover:border-[#1ABC9C] transition-colors"
          >
