...
describe('AuthController', () => {
  let service: { signup: ReturnType<typeof vi.fn>; signin: ReturnType<typeof vi.fn>; whoami: ReturnType<typeof vi.fn>; signout: ReturnType<typeof vi.fn>; changePassword: ReturnType<typeof vi.fn> };
  ...
  it('signup delegates to AuthService.signup', () => {
    const dto = { fullname: 'A', email: 'a@example.com', password: 'password123' };
  ...
  it('changePassword passes the authenticated user id and dto to AuthService.changePassword', () => {
    const payload = { id: 'user-1' } as AuthJwtPayload;
    const dto = { currentPassword: 'a', newPassword: 'b', confirmPassword: 'b' };
