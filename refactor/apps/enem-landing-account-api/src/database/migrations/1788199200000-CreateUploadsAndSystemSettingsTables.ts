...
export class CreateUploadsAndSystemSettingsTables1788199200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'files',
      new TableIndex({
        name: 'file_app_purpose_idx',
        columnNames: ['app', 'purpose'],
      }),
    );
    await queryRunner.createIndex(
      'files',
      new TableIndex({
        name: 'file_uploader_id_idx',
